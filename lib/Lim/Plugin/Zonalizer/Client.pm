package Lim::Plugin::Zonalizer::Client;
...
Lim::Plugin::Zonalizer::Client - Client class for the zonalizer Lim plugin
...
See L<Lim::Plugin::Zonalizer> for list of calls and arguments.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Lim::Plugin::Zonalizer::Client
...
1;    # End of Lim::Plugin::Zonalizer::Client
